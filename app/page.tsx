...
const collections: Card08Props[] = [
  ...
  },
  {
    ...
    subtitle: "job portal with rectruiter & applicant interfaces",
...
export default function Page() {
  ...
  return (
    ...
    <main id="hero" className="relative min-h-[200vh] overflow-x-clip px-20 bg-gradient-to-b from-black to-black">
      ...
      {/* HERO / INTRO */}
      <section id="intro" className=" text-white container mx-auto px-6 pt-6 md:pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="relative z-10">
            ...
            <p className="mt-4  md:text-xl text-white">
              I build dynamic and user-friendly digital experiences with React, Next.js, and expressive UI motion. Based in Pune, India.
            </p>
      ...
      <section id="projects" className="container mx-auto px-6 py-16 md:py-24">
        <h3 className="text-2xl md:text-4xl text-white font-semibold mt-12">Projects</h3>
