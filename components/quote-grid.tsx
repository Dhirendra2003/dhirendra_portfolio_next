...
function QuoteGrid() {
  return (
    <div className={` xs:py-44 flex flex-col place-content-center bg-white ${poppins.className} text-center` }>
      <div className='w-[70%]  m-auto flex flex-col items-center   gap-4 rounded-2xl '>
        <div className='flex gap-4 xs:flex-wrap md:flex-nowrap xs:place-content-center  '>
          <div className='bg-star-blue text-white font-medium  p-3 hover:scale-95 transition-all duration-500 ease-in-out hover:z-40 hover:shadow-xl bg-gradient-to-br from-rose-400 to-black rounded-tl-4xl overflow-hidden flex items-center justify-center'>
          ...
          <div className='flex flex-col '>
            {/* <Image alt='' width={240} height={60} src="/quotefont.webp" className='w-60 hover:scale-95 transition-all duration-500 ease-in-out hover:z-40 ' /> */}
          ...
          <div className='text-white bg-gradient-to-bl from-blue-500 to-black  p-3 hover:scale-95 transition-all duration-500 ease-in-out hover:z-40 hover:shadow-xl rounded-tr-4xl overflow-hidden flex items-center justify-center'>
            <p className='text-xl  font-medium'>  Developed web applications <br /> integrating dynamic content with REST APIs and MongoDB. <br />
        ...
        <div className='flex gap-4 xs:flex-wrap md:flex-nowrap '>
          <div className='bg-gradient-to-tr from-purple-600 to bg-black text-white md:text-2xl xs:text-xl p-3 font-medium hover:scale-95 transition-all duration-500 ease-in-out hover:z-40 hover:shadow-xl rounded-bl-4xl overflow-hidden flex items-center justify-center'>
...
<br />
          ...
          <div className='bg-gradient-to-br from-black to-cyan-600 text-white text-xl p-3 font-medium hover:scale-95 transition-all duration-500 ease-in-out hover:z-40 hover:shadow-xl rounded-br-4xl ' >
...
<Button asChild size="lg" className=" underline_hover bg-gradient-to-br from-fuchsia-600 via-pink-600 to-amber-500 text-white shadow-lg hover:shadow-xl">
                <a href="/resume.pdf" download>Download Resume <Download className='w-4 h-4 ml-2' /></a>
              </Button>
</a>
    </div>
  )
